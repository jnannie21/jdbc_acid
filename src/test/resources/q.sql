...
insert into student (id, first_name, last_name, age, points, team_id) values (1, 'dima', 'dimin', 33, 10, 1);
insert into student (id, first_name, last_name, age, points, team_id) values (2, 'vasia', 'vasin', 44, 22, 2);
